...
public:
	...
	TArray<struct FGameplayTag>                   GenericTagsToApply;                                // 0x0158(0x0010)(Edit, BlueprintVisible, DisableEditOnInstance)
	...
	EInteriorAudioState                           Current_State;                                     // 0x0169(0x0001)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                         Pad_16A[0x2];                                      // 0x016A(0x0002)(Fixing Size After Last Property [ Dumper-8 ])
	struct FGameplayTag                           Current_Room_Size_Tag;                             // 0x016C(0x0008)(Edit, BlueprintVisible, DisableEditOnInstance, NoDestructor, HasGetValueTypeHash)
	uint8                                         Pad_174[0x4];                                      // 0x0174(0x0004)(Fixing Size After Last Property [ Dumper-8 ])
	TMap<struct FGameplayTag, class UReverbEffect*> Reverbs;                                         // 0x0178(0x0050)(Edit, BlueprintVisible, DisableEditOnInstance)
