...
{
public:
	TMulticastInlineDelegate<void(bool Accepted)> OnEulaResponse;                                    // 0x04B0(0x0010)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, BlueprintAssignable, BlueprintCallable)
