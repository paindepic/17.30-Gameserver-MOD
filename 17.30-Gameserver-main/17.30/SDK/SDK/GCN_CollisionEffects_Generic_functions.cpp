...
#include "GCN_CollisionEffects_Generic_classes.hpp"
#include "GCN_CollisionEffects_Generic_parameters.hpp"


namespace SDK
{

// Function GCN_CollisionEffects_Generic.GCN_CollisionEffects_Generic_C.OnBurstGeneric
...
void UGCN_CollisionEffects_Generic_C::OnBurstGeneric(class AActor* MyTarget, const struct FGameplayCueParameters& Parameters, const TArray<class UFXSystemComponent*>& ParticleComponents, const TArray<class UAudioComponent*>& AudioComponents, class UMatineeCameraShake* BurstCameraShakeInstance, class ADecalActor* BurstDecalInstance) const
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("GCN_CollisionEffects_Generic_C", "OnBurstGeneric");

	Params::GCN_CollisionEffects_Generic_C_OnBurstGeneric Parms{};
