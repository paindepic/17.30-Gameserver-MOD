...
public:
	...
	TArray<class AFortPlayerController*>          K2Node_MakeArray_Array;                            // 0x0040(0x0010)(ReferenceParm)
	...
	TArray<struct FVector>                        CallFunc_GetProjectileTrajectoryPoints_OutSplinePoints; // 0x0088(0x0010)(ReferenceParm)
	TArray<struct FVector>                        CallFunc_GetProjectileTrajectoryPoints_OutSplineTangents; // 0x0098(0x0010)(ReferenceParm)
	struct FHitResult                             CallFunc_GetProjectileTrajectoryPoints_OutHitResult; // 0x00A8(0x0088)(IsPlainOldData, NoDestructor, ContainsInstancedReference)
	bool                                          CallFunc_Is_Trajectory_Hidden_IsHidden;            // 0x0130(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
