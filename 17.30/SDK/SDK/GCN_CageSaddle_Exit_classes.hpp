...
// BlueprintGeneratedClass GCN_CageSaddle_Exit.GCN_CageSaddle_Exit_C
// 0x0008 (0x01B0 - 0x01A8)
class UGCN_CageSaddle_Exit_C final : public UFortGameplayCueNotify_Burst
{
public:
	struct FPointerToUberGraphFrame               UberGraphFrame;                                    // 0x01A8(0x0008)(ZeroConstructor, Transient, DuplicateTransient)

public:
	void ExecuteUbergraph_GCN_CageSaddle_Exit(int32 EntryPoint);
...
public:
	...
	{
		return StaticBPGeneratedClassImpl<"GCN_CageSaddle_Exit_C">();
	}
	static class UGCN_CageSaddle_Exit_C* GetDefaultObj()
	{
		return GetDefaultObjImpl<UGCN_CageSaddle_Exit_C>();
	}
};
