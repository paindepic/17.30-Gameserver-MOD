...
public:
	...
	TArray<class UFortNonPlayerConversationParticipantComponent*> ConversationParticipantsInRange;   // 0x0190(0x0010)(ExportObject, ZeroConstructor, Transient, ContainsInstancedReference, NativeAccessSpecifierPrivate)
	...
	uint8                                         Pad_234[0x2C];                                     // 0x0234(0x002C)(Fixing Size After Last Property [ Dumper-8 ])
	struct FUserWidgetPool                        DialogWidgetPool;                                  // 0x0260(0x0088)(Transient, ContainsInstancedReference, NativeAccessSpecifierPrivate)
	TMap<class UFortNonPlayerConversationParticipantComponent*, class UUserWidget*> ComponentToIndicator; // 0x02E8(0x0050)(ExportObject, Transient, ContainsInstancedReference, NativeAccessSpecifierPrivate)
