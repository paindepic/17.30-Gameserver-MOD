...
#include "GCN_CollisionEffects_Stone_classes.hpp"
#include "GCN_CollisionEffects_Stone_parameters.hpp"


namespace SDK
{

// Function GCN_CollisionEffects_Stone.GCN_CollisionEffects_Stone_C.OnBurstGeneric
...
void UGCN_CollisionEffects_Stone_C::OnBurstGeneric(class AActor* MyTarget, const struct FGameplayCueParameters& Parameters, const TArray<class UFXSystemComponent*>& ParticleComponents, const TArray<class UAudioComponent*>& AudioComponents, class UMatineeCameraShake* BurstCameraShakeInstance, class ADecalActor* BurstDecalInstance) const
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("GCN_CollisionEffects_Stone_C", "OnBurstGeneric");

	Params::GCN_CollisionEffects_Stone_C_OnBurstGeneric Parms{};
