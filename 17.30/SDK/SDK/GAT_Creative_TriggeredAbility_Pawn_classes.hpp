...
{
public:
	struct FPointerToUberGraphFrame               UberGraphFrame_GAT_Creative_TriggeredAbility_Pawn_C; // 0x0AC8(0x0008)(ZeroConstructor, Transient, DuplicateTransient)
	class AFortPawn*                              AbilityOwner;                                      // 0x0AD0(0x0008)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnTemplate, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
