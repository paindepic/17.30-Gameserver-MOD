...
namespace Offsets
{
	constexpr int32 GObjects          = 0x097D1D38;
	constexpr int32 AppendString      = 0x00EC3B0C;
	constexpr int32 GNames            = 0x09A0FF00;
	constexpr int32 GWorld            = 0x099B5930;
	constexpr int32 ProcessEvent      = 0x00CD8848;
	constexpr int32 ProcessEventIdx   = 0x00000044;
    constexpr int32 Free              = 0x54758F8;
    constexpr int32 Realloc           = 0x1ADF5E4;
}
