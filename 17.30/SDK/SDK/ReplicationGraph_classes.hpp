...
public:
	...
	uint8                                         Pad_B8[0x480];                                     // 0x00B8(0x0480)(Fixing Struct Size After Last Property [ Dumper-8 ])
...
{
public:
	class UReplicationGraphNode_GridSpatialization2D* GridNode;                                      // 0x0538(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class UReplicationGraphNode_ActorList*        AlwaysRelevantNode;                                // 0x0540(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	TArray<struct FConnectionAlwaysRelevantNodePair> AlwaysRelevantForConnectionList;                // 0x0548(0x0010)(ZeroConstructor, NativeAccessSpecifierPublic)
	TArray<class AActor*>                         ActorsWithoutNetConnection;                        // 0x0558(0x0010)(ZeroConstructor, NativeAccessSpecifierPublic)
...
public:
	...
	uint8                                         Pad_1C8[0x80];                                     // 0x01C8(0x0080)(Fixing Struct Size After Last Property [ Dumper-8 ])
