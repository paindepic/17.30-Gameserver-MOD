...
{
public:
	TArray<class FName>                           HandleNames;                                       // 0x0038(0x0010)(Edit, ZeroConstructor, Transient, Config, NativeAccessSpecifierPrivate)
	TArray<struct FSoftClassPath>                 ConfiguredDataHandlers;                            // 0x0048(0x0010)(Edit, ZeroConstructor, Transient, Config, NativeAccessSpecifierPrivate)
...
public:
	...
	TArray<class ULiveStreamAnimationDataHandler*> ConfiguredDataHandlers;                           // 0x0068(0x0010)(ZeroConstructor, Transient, NativeAccessSpecifierPrivate)
