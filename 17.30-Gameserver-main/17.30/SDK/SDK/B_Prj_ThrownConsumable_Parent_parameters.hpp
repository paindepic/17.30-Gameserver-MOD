...
public:
	...
	struct FHitResult                             K2Node_ComponentBoundEvent_ImpactResult;           // 0x0184(0x0088)(ConstParm, IsPlainOldData, NoDestructor, ContainsInstancedReference)
	...
	TScriptInterface<class IFortVehicleInterface> K2Node_DynamicCast_AsFort_Vehicle_Interface;       // 0x02E0(0x0010)(ZeroConstructor, IsPlainOldData, NoDestructor)
	...
	class ABuildingActor*                         K2Node_DynamicCast_AsBuilding_Actor;               // 0x02F8(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	class AActor*                                 CallFunc_GetVehicleActorPtrConst_ReturnValue;      // 0x0308(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	struct FHitResult                             K2Node_Event_Hit;                                  // 0x0324(0x0088)(ConstParm, IsPlainOldData, NoDestructor, ContainsInstancedReference)
	bool                                          CallFunc_BreakHitResult_bBlockingHit_2;            // 0x03AC(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	bool                                          CallFunc_BreakHitResult_bInitialOverlap_2;         // 0x03AD(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	...
	TDelegate<void(class AActor* DestroyedActor)> K2Node_CreateDelegate_OutputDelegate_1;            // 0x042C(0x0010)(ZeroConstructor, NoDestructor)
	bool                                          CallFunc_ComponentHasTag_ReturnValue;              // 0x043C(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	...
	TArray<class AActor*>                         K2Node_Event_HitActors;                            // 0x0450(0x0010)(ConstParm, ReferenceParm)
	TArray<struct FHitResult>                     K2Node_Event_HitResults;                           // 0x0460(0x0010)(ConstParm, ReferenceParm, ContainsInstancedReference)
