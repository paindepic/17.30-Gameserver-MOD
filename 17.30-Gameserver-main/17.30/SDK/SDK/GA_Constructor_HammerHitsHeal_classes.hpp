...
{
public:
	struct FPointerToUberGraphFrame               UberGraphFrame_GA_Constructor_HammerHitsHeal_C;    // 0x0C40(0x0008)(ZeroConstructor, Transient, DuplicateTransient)
	struct FGameplayTagContainer                  TC_RequiredTags;                                   // 0x0C48(0x0020)(Edit, BlueprintVisible, DisableEditOnInstance)
