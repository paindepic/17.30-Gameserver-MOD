...
class UGCN_Athena_Mother_Scooter_Projectile_Hit_C final : public UFortGameplayCueNotify_Burst
{
public:
...
public:
	...
	{
		return StaticBPGeneratedClassImpl<"GCN_Athena_Mother_Scooter_Projectile_Hit_C">();
	}
	static class UGCN_Athena_Mother_Scooter_Projectile_Hit_C* GetDefaultObj()
	{
		return GetDefaultObjImpl<UGCN_Athena_Mother_Scooter_Projectile_Hit_C>();
	}
};
