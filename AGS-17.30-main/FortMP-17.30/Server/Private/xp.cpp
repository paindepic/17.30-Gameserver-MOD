...
void XP::Challanges::SendStatEvent(UFortQuestManager* ManagerComp, UObject* TargetObject, FGameplayTagContainer& AdditionalSourceTags, FGameplayTagContainer& TargetTags, bool* QuestActive, bool* QuestCompleted, int32 Count, EFortQuestObjectiveStatEvent StatEvent)
{
	...
	if (StatEvent == EFortQuestObjectiveStatEvent::Kill)
	{
		...
		static UFortAccoladeItemDefinition* ElimDef = Utils::StaticLoadObject<UFortAccoladeItemDefinition>("/BattlePassPermanentQuests/Items/Accolades/AccoladeId_012_Elimination.AccoladeId_012_Elimination");
		static UFortAccoladeItemDefinition* ElimDef1 = Utils::StaticLoadObject<UFortAccoladeItemDefinition>("/BattlePassPermanentQuests/Items/Accolades/AccoladeId_014_Elimination_Bronze.AccoladeId_014_Elimination_Bronze");
		static UFortAccoladeItemDefinition* ElimDef4 = Utils::StaticLoadObject<UFortAccoladeItemDefinition>("/BattlePassPermanentQuests/Items/Accolades/AccoladeId_015_Elimination_Silver.AccoladeId_015_Elimination_Silver");
		static UFortAccoladeItemDefinition* ElimDef8 = Utils::StaticLoadObject<UFortAccoladeItemDefinition>("/BattlePassPermanentQuests/Items/Accolades/AccoladeId_016_Elimination_Gold.AccoladeId_016_Elimination_Gold");
	...
	if (StatEvent == EFortQuestObjectiveStatEvent::Interact)
	{
		...
		if (IsChest)
		{
			static auto SearchDef = Utils::StaticLoadObject<UFortAccoladeItemDefinition>("/BattlePassPermanentQuests/Items/Accolades/AccoladeId_007_SearchChests.AccoladeId_007_SearchChests");
		...
		{
			static auto SearchDef = Utils::StaticLoadObject<UFortAccoladeItemDefinition>("/BattlePassPermanentQuests/Items/Accolades/AccoladeId_011_SearchAmmoBox.AccoladeId_011_SearchAmmoBox");
			Accolades::GiveAccolade((AFortPlayerControllerAthena*)ManagerComp->GetPlayerControllerBP(), SearchDef, nullptr, EXPEventPriorityType::NearReticle);
		}
	}
...
bool XP::Challanges::SendDistanceUpdate(UGameplayAbility* Ability)
{
	...
	if (!UWorld::GetWorld() || !UWorld::GetWorld()->GameState || UWorld::GetWorld()->Name.ComparisonIndex != map.ComparisonIndex || ((AFortGameStateAthena*)UWorld::GetWorld()->GameState)->GamePhase <= EAthenaGamePhase::Aircraft)
		return true;
	static UClass* SandTunnelClass = Utils::StaticLoadObject<UClass>("/BattlepassS15/Items/QuestAbilities/Quest_Distance_SandTunneling/GA_Quest_Distance_SandTunneling.GA_Quest_Distance_SandTunneling_C");
	static UClass* OnFootClass = Utils::StaticLoadObject<UClass>("/BattlepassS15/Items/QuestAbilities/Quest_Distance_OnFoot/GA_Quest_Distance_OnFoot.GA_Quest_Distance_OnFoot_C");
	static UClass* SwimDistanceClass = Utils::StaticLoadObject<UClass>("/BattlepassS15/Items/QuestAbilities/Milestone/SwimDistance/GA_Quest_Milestone_SwimDistance.GA_Quest_Milestone_SwimDistance_C");
	static UClass* VehicleDistanceClass = Utils::StaticLoadObject<UClass>("/BattlepassS15/Items/QuestAbilities/Milestone/VehicleDistance/GA_Quest_Milestone_VehicleDistance.GA_Quest_Milestone_VehicleDistance_C");
	static UClass* GlideDistanceClass = Utils::StaticLoadObject<UClass>("/BattlepassS15/Items/QuestAbilities/Milestone/GlideDistance/GA_Quest_Milestone_GlideDistance.GA_Quest_Milestone_GlideDistance_C");
	...
	if (Ability->Class == SandTunnelClass)
	{
		...
		if (!PlayerController)
			return false;
		static auto MetersTravelledOffset = Utils::GetOffset(Ability, "MetersTravelled");
	...
	else if (Ability->Class == SwimDistanceClass)
	{
		...
		if (!PlayerController->MyFortPawn)
			return false;
		static auto MetersTravelledOffset = Utils::GetOffset(Ability, "MetersTraveled");
		int& MetersTravelled = *(int*)(__int64(Ability) + MetersTravelledOffset);
		bool bruh;
		FGameplayTagContainer Empty{};
