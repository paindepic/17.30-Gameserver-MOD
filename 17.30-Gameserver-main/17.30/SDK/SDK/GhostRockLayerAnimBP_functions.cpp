...
// Function GhostRockLayerAnimBP.GhostRockLayerAnimBP_C.BlueprintUpdateAnimation
// (Event, Public, BlueprintEvent)
// Parameters:
// float                                   DeltaTimeX                                             (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)

void UGhostRockLayerAnimBP_C::BlueprintUpdateAnimation(float DeltaTimeX)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("GhostRockLayerAnimBP_C", "BlueprintUpdateAnimation");

	Params::GhostRockLayerAnimBP_C_BlueprintUpdateAnimation Parms{};
