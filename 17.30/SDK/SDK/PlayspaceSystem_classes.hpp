...
{
public:
	uint8                                         Pad_6A8[0x18];                                     // 0x06A8(0x0018)(Fixing Size After Last Property [ Dumper-8 ])
	bool                                          bUsePlayerSpawningComponent;                       // 0x06C0(0x0001)(Edit, ZeroConstructor, Config, DisableEditOnInstance, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                         Pad_6C1[0x7];                                      // 0x06C1(0x0007)(Fixing Size After Last Property [ Dumper-8 ])
	TSubclassOf<class UPlayspaceControllerComponent_PlayerSpawning> ControllerSpawningComponent;     // 0x06C8(0x0008)(Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
...
public:
	...
	uint8                                         Pad_D0[0xD8];                                      // 0x00D0(0x00D8)(Fixing Size After Last Property [ Dumper-8 ])
