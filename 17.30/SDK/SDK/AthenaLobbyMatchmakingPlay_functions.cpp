...
// Parameters:
// const bool                              bIsSquadFillEnabled                                    (ConstParm, BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor)

void UAthenaLobbyMatchmakingPlay_C::OnSquadFillEnabledChanged(const bool bIsSquadFillEnabled)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("AthenaLobbyMatchmakingPlay_C", "OnSquadFillEnabledChanged");

	Params::AthenaLobbyMatchmakingPlay_C_OnSquadFillEnabledChanged Parms{};

	Parms.bIsSquadFillEnabled = bIsSquadFillEnabled;
