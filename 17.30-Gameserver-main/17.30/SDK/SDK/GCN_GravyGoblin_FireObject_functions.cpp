...
#include "GCN_GravyGoblin_FireObject_classes.hpp"
#include "GCN_GravyGoblin_FireObject_parameters.hpp"
...
void UGCN_GravyGoblin_FireObject_C::OnBurstGeneric(class AActor* MyTarget, const struct FGameplayCueParameters& Parameters, const TArray<class UFXSystemComponent*>& ParticleComponents, const TArray<class UAudioComponent*>& AudioComponents, class UMatineeCameraShake* BurstCameraShakeInstance, class ADecalActor* BurstDecalInstance) const
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("GCN_GravyGoblin_FireObject_C", "OnBurstGeneric");

	Params::GCN_GravyGoblin_FireObject_C_OnBurstGeneric Parms{};
