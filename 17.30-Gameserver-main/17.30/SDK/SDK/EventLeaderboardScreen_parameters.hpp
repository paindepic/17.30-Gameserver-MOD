...
public:
	...
	class UCommonButtonLegacy*                    K2Node_ComponentBoundEvent_Button;                 // 0x0298(0x0008)(ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
